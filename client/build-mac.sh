...
cp /usr/local/Cellar/glew/1.9.0/lib/libGLEW.1.9.0.dylib $APP_PATH/Contents/MacOS
cp /usr/local/Cellar/glfw/2.7.7/lib/libglfw.dylib $APP_PATH/Contents/MacOS

# relink binary to point to shared libs in local path
install_name_tool -change /usr/local/lib/libGLEW.1.9.0.dylib  @executable_path/libGLEW.1.9.0.dylib $APP_PATH/Contents/MacOS/THEWARCLIENT
